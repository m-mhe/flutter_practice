          ...
          children:[
            ElevatedButton(
              ...
              onPressed: (){
                ...
                Navigator.push(context, //With push we add a page in stack data structure (LIFO: Last In First Out).
            ...
            ElevatedButton(
              ...
              onPressed: (){
                Navigator.push(context,
                  MaterialPageRoute(builder: (context){
                    return const Profile(name: "From Home"); //Taking data(name: "From Home") from current page.
                  })
